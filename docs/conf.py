...
# -*- coding: utf-8 -*-
#
# cdtool documentation build configuration file, created by
...
init_file = os.path.join('..', 'cdtool', '__init__.py')
...
latex_documents = [
    (master_doc, 'cdtool.tex',
     u'cdtool Documentation',
